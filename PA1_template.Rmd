...
The mean and the median total steps are **`r mean1`** and **`r median1`** respectively.
...
```
The maximum average steps is **`r maximumInterval$x`** at interval starting **`r maximumInterval$intervalLabel`**.
...
The mean and the median total steps are **`r mean3`** and **`r median3`** respectively. With the substitution, more steps are recorded each day as compared to the first part. This has resulted in a higher mean and median.
